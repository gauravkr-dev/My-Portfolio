...
export const Navbar = () => {
  ...
  return (
    <>
      <nav className="fixed inset-x-4 md:left-1/2 md:right-auto md:-translate-x-1/2 transform z-50 w-auto max-w-5xl md:w-full transition-all duration-300 mt-4 md:px-8 border border-primary/40 py-2 bg-transparent backdrop-blur-sm rounded-xl">
